function DisplayZSliceFrom3D_EI(sub_ny,ResultMatrix,WhatToSee,DimX,DimY,DimZ,ZSlicesIndicies,caxisvalue,ProdCoord,ProdName)
...
for k=1:size(Data_Partial,1)
    ...
    %sub_ny=1;
    figure;
    set(gcf, 'Units', 'normalized', 'Position', [0.3,0.3,0.2,0.4]);
...
%        title(['Model ',num2str(k),' z= ',num2str(ZSlicesIndicies(j))],'Fontsize',16)
        ...
        title(['EigenImage ',num2str(WhatToSee)],'Fontsize',16)
